...
<form id="cadastro-facial" method="post" action="trocar_foto.php" enctype="multipart/form-data">
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            <label for="foto" class="camara-input-label">Selecionar Foto Para Troca </label>
